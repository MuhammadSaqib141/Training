...
// app.http('send-messages-to-queue-using-httptigger', {
//     methods: ['GET', 'POST'],
//     authLevel: 'anonymous',
//     handler: async (request, context) => {
//         context.log("HTTP-triggered function started to send messages to Service Bus.");
...
//             context.log(`Messages sent successfully to queue: ${queueName}`);
//             return { status: 200, body: "Messages sent successfully!" };
//         } catch (err) {
